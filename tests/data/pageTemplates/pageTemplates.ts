...
const pageTemplates: PagesTemplateModel[] = [
  {
    ...
    mainBanner: {
      index: 1,
      url: `/assets/${ASSETS_DIST_TEMPLATES}/page_a/main-banner.jpg`,
    },
    secondaryBanner: {
      index: 1,
      url: `/assets/${ASSETS_DIST_TEMPLATES}/page_a/secondary-banner-1.jpg`,
    },
    updatedAt: new Date(),
    createdAt: new Date(),
  },
  {
    ...
    mainBanner: {
      index: 1,
      url: `/assets/${ASSETS_DIST_TEMPLATES}/page_b/main-banner.jpg`,
    },
    secondaryBanner: {
      index: 1,
      url: `/assets/${ASSETS_DIST_TEMPLATES}/page_b/secondary-banner-2.jpg`,
    },
    updatedAt: new Date(),
    createdAt: new Date(),
  },
  ...
  },
  {
    ...
    mainBanner: {
      index: 1,
      url: `/assets/${ASSETS_DIST_TEMPLATES}/page_d/main-banner.jpg`,
    },
    secondaryBanner: {
      index: 1,
      url: `/assets/${ASSETS_DIST_TEMPLATES}/page_d/secondary-banner-3.jpg`,
    },
    updatedAt: new Date(),
    createdAt: new Date(),
  },
