...
const ProductSnippetGridDefault = dynamic(() => import('components/layout/snippet/ProductSnippetGridDefault'));
const ProductSnippetGridBigImage = dynamic(() => import('components/layout/snippet/ProductSnippetGridBigImage'));
