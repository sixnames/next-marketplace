...
export interface NexusGenInputs {
  ...
  UpdateAttributesGroupInRubricInput: {
    // input type
    attributeId: NexusGenScalars['ObjectId']; // ObjectId!
    attributesGroupId: NexusGenScalars['ObjectId']; // ObjectId!
    rubricId: NexusGenScalars['ObjectId']; // ObjectId!
...
export interface NexusGenObjects {
  ...
  CatalogueFilter: dbModels.CatalogueFilterModel;
  ...
  CatalogueFilterSelectedPrices: dbModels.CatalogueFilterSelectedPricesModel;
  ...
  OrdersPaginationPayload: dbModels.OrdersPaginationPayloadModel;
  PointGeoJSON: dbModels.PointGeoJSONModel;
  Product: dbModels.ProductModel;
  ProductAttribute: dbModels.ProductAttributeModel;
  ProductAttributesGroupAst: dbModels.ProductAttributesGroupAstModel;
  ...
  ProductSnippetFeatures: dbModels.ProductSnippetFeaturesModel;
...
export interface NexusGenFieldTypes {
  ...
  Attribute: {
    ...
    optionsGroupId: NexusGenScalars['ObjectId'] | null; // ObjectId
    optionsIds: NexusGenScalars['ObjectId'][]; // [ObjectId!]!
    positioningInTitle: NexusGenScalars['JSONObject'] | null; // JSONObject
  ...
  Cart: {
    ...
    isWithShopless: boolean; // Boolean!
  ...
  CartPayload: {
    // field return type
    message: string; // String!
    payload: NexusGenRootTypes['Cart'] | null; // Cart
    success: boolean; // Boolean!
  };
  CartProduct: {
    // field return type
  ...
  CatalogueData: {
    // field return type
    _id: NexusGenScalars['ObjectId']; // ObjectId!
    catalogueFilter: NexusGenRootTypes['CatalogueFilter']; // CatalogueFilter!
  ...
  CatalogueFilter: {
    ...
    selectedPrices: NexusGenRootTypes['CatalogueFilterSelectedPrices'] | null; // CatalogueFilterSelectedPrices
  };
  CatalogueFilterAttribute: {
    ...
    name: string; // String!
    options: NexusGenRootTypes['CatalogueFilterAttributeOption'][]; // [CatalogueFilterAttributeOption!]!
    slug: string; // String!
  };
  ...
  Mutation: {
    ...
    updateAttributesGroupInRubric: NexusGenRootTypes['RubricPayload']; // RubricPayload!
  ...
  Order: {
    ...
    formattedTotalPrice: string; // String!
    itemId: number; // Int!
    logs: NexusGenRootTypes['OrderLog'][]; // [OrderLog!]!
  ...
  OrdersPaginationPayload: {
    // field return type
    docs: NexusGenRootTypes['Order'][]; // [Order!]!
    hasNextPage: boolean; // Boolean!
    hasPrevPage: boolean; // Boolean!
    limit: number; // Int!
    page: number; // Int!
  ...
  Product: {
    ...
    slug: string; // String!
    snippetFeatures: NexusGenRootTypes['ProductSnippetFeatures']; // ProductSnippetFeatures!
    updatedAt: NexusGenScalars['Date']; // Date!
    views: NexusGenScalars['JSONObject']; // JSONObject!
  };
  ProductAttribute: {
    ...
    attributesGroup: NexusGenRootTypes['AttributesGroup']; // AttributesGroup!
    attributesGroupId: NexusGenScalars['ObjectId']; // ObjectId!
    number: number | null; // Float
    readableValue: string | null; // String
    selectedOptions: NexusGenRootTypes['Option'][]; // [Option!]!
    selectedOptionsSlugs: string[]; // [String!]!
    showAsBreadcrumb: boolean; // Boolean!
    showInCard: boolean; // Boolean!
    text: string; // String!
  ...
  ProductSnippetFeatures: {
    // field return type
    _id: NexusGenScalars['ObjectId']; // ObjectId!
    listFeaturesString: string; // String!
    ratingFeaturesValues: string[]; // [String!]!
  };
  ...
  Query: {
    ...
    getAllMyOrders: NexusGenRootTypes['OrdersPaginationPayload'] | null; // OrdersPaginationPayload
    ...
    getProductAttributesAST: NexusGenRootTypes['ProductAttributesGroupAst'][]; // [ProductAttributesGroupAst!]!
  ...
  Rubric: {
    ...
    children: NexusGenRootTypes['Rubric'][]; // [Rubric!]!
    description: string; // String!
    descriptionI18n: NexusGenScalars['JSONObject']; // JSONObject!
    level: number; // Int!
    name: string; // String!
    ...
    parent: NexusGenRootTypes['Rubric'] | null; // Rubric
    parentId: NexusGenScalars['ObjectId'] | null; // ObjectId
    priorities: NexusGenScalars['JSONObject']; // JSONObject!
    products: NexusGenRootTypes['ProductsPaginationPayload']; // ProductsPaginationPayload!
  ...
  RubricAttributesGroup: {
    ...
    showInCatalogueFilter: NexusGenScalars['ObjectId'][]; // [ObjectId!]!
  };
  ...
  User: {
    ...
    lastName: string | null; // String
    name: string; // String!
    orders: NexusGenRootTypes['OrdersPaginationPayload']; // OrdersPaginationPayload!
    phone: NexusGenScalars['PhoneNumber']; // PhoneNumber!
...
export interface NexusGenFieldTypeNames {
  ...
  CatalogueFilter: {
    ...
    selectedPrices: 'CatalogueFilterSelectedPrices';
  };
  CatalogueFilterAttribute: {
    // field return type name
    _id: 'ObjectId';
  ...
  Query: {
    ...
    getAllMyOrders: 'OrdersPaginationPayload';
    ...
    getOrder: 'Order';
    getProduct: 'Product';
    getProductAttributesAST: 'ProductAttributesGroupAst';
  ...
  RubricAttributesGroup: {
    ...
    attributesGroupId: 'ObjectId';
    isOwner: 'Boolean';
    showInCatalogueFilter: 'ObjectId';
  };
  RubricCatalogueTitle: {
    // field return type name
    defaultTitle: 'String';
...
export interface NexusGenArgTypes {
  ...
  Mutation: {
    ...
    updateAttributesGroupInRubric: {
      // args
      input: NexusGenInputs['UpdateAttributesGroupInRubricInput']; // UpdateAttributesGroupInRubricInput!
    };
    updateBrand: {
      // args
  ...
  Query: {
    ...
    getCatalogueData: {
      // args
      catalogueFilter: string[]; // [String!]!
      productsInput: NexusGenInputs['ProductsPaginationInput']; // ProductsPaginationInput!
    };
    ...
    getProductAttributesAST: {
      // args
      input: NexusGenInputs['ProductAttributesASTInput']; // ProductAttributesASTInput!
    };
    getProductBySlug: {
      // args
      slug: string; // String!
