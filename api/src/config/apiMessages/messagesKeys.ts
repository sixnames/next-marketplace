const messagesKeys = [
  ...
  'roles.setRoleOperationPermission.notFound',
  'roles.setRoleOperationPermission.error',
  'roles.setRoleOperationPermission.success',
  'roles.setRoleOperationCustomFilter.notFound',
  'roles.setRoleOperationCustomFilter.error',
  'roles.setRoleOperationCustomFilter.success',
  'roles.setRoleRuleRestrictedField.notFound',
  'roles.setRoleRuleRestrictedField.error',
  'roles.setRoleRuleRestrictedField.success',
  'roles.setRoleAllowedNavItem.notFound',
  'roles.setRoleAllowedNavItem.error',
  'roles.setRoleAllowedNavItem.success',
  // Roles validation
  'validation.roles.id',
  'validation.roles.name',
  'validation.roles.description',
  'validation.roles.isStuff',
  'validation.roles.allow',
  'validation.roles.restrictedField',
  'validation.roles.ruleId',
  'validation.roles.navItemId',
  'validation.roles.operationId',
  'validation.roles.customFilter',
