...
export type MutationUpdateVisibleNavEventRubricConfigArgs = {
  input: UpdateVisibleNavEventRubricConfigInput;
};
...
export type UpdateVisibleNavEventRubricConfigInput = {
  _id: Scalars['ObjectId'];
  multi: Scalars['Boolean'];
  acceptedFormats: Array<Scalars['String']>;
  slug: Scalars['String'];
...
export type UpdateVisibleNavEventRubricConfigMutationVariables = Exact<{
  input: UpdateVisibleNavEventRubricConfigInput;
}>;


export type UpdateVisibleNavEventRubricConfigMutation = (
  { __typename?: 'Mutation' }
...
export const UpdateVisibleNavEventRubricConfigDocument = gql`
  ...
  updateVisibleNavEventRubricConfig(input: $input) {
    ...
    `;
export type UpdateVisibleNavEventRubricConfigMutationFn = Apollo.MutationFunction<UpdateVisibleNavEventRubricConfigMutation, UpdateVisibleNavEventRubricConfigMutationVariables>;

/**
 * __useUpdateVisibleNavEventRubricConfigMutation__
 *
 * To run a mutation, you first call `useUpdateVisibleNavEventRubricConfigMutation` within a React component and pass it any options that fit your needs.
 * When your component renders, `useUpdateVisibleNavEventRubricConfigMutation` returns a tuple that includes:
 * - A mutate function that you can call at any time to execute the mutation
 * - An object with fields that represent the current status of the mutation's execution
 *
 * @param baseOptions options that will be passed into the mutation, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options-2;
 *
 * @example
 * const [updateVisibleNavEventRubricConfigMutation, { data, loading, error }] = useUpdateVisibleNavEventRubricConfigMutation({
 *   variables: {
 *      input: // value for 'input'
 *   },
 * });
 */
export function useUpdateVisibleNavEventRubricConfigMutation(baseOptions?: Apollo.MutationHookOptions<UpdateVisibleNavEventRubricConfigMutation, UpdateVisibleNavEventRubricConfigMutationVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useMutation<UpdateVisibleNavEventRubricConfigMutation, UpdateVisibleNavEventRubricConfigMutationVariables>(UpdateVisibleNavEventRubricConfigDocument, options);
      }
export type UpdateVisibleNavEventRubricConfigMutationHookResult = ReturnType<typeof useUpdateVisibleNavEventRubricConfigMutation>;
export type UpdateVisibleNavEventRubricConfigMutationResult = Apollo.MutationResult<UpdateVisibleNavEventRubricConfigMutation>;
export type UpdateVisibleNavEventRubricConfigMutationOptions = Apollo.BaseMutationOptions<UpdateVisibleNavEventRubricConfigMutation, UpdateVisibleNavEventRubricConfigMutationVariables>;
