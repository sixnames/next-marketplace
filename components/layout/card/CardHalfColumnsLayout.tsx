...
import CardControls from 'components/layout/card/CardControls';
import CardDynamicContent from 'components/layout/card/CardDynamicContent';
import CardIconFeatures from 'components/layout/card/CardIconFeatures';
import CardPrices from 'components/layout/card/CardPrices';
import CardRatingFeatures from 'components/layout/card/CardRatingFeatures';
import CardShopsList from 'components/layout/card/CardShopsList';
import CardSimilarProducts from 'components/layout/card/CardSimilarProducts';
import CardTagFeatures from 'components/layout/card/CardTagFeatures';
import CardTextFeatures from 'components/layout/card/CardTextFeatures';

const CardImageSlider = dynamic(() => import('components/layout/card/CardImageSlider'));
const CardSimpleGallery = dynamic(() => import('components/layout/card/CardSimpleGallery'));
