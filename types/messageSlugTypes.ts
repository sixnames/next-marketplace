export type MessageSlug =
  ...
  | 'products.variant.exist'
  | 'products.variant.createError'
  | 'products.variant.updateError'
  | 'products.variant.deleteError'
  | 'products.variant.noAttributeError'
  | 'products.variant.intersect'
  | 'products.variant.createSuccess'
  | 'products.variant.addProductSuccess'
  | 'products.variant.deleteProductSuccess'
  // Products validation
