...
const pages: PageModel[] = [
  ...
  },
  {
    ...
    mainBanner: {
      index: 1,
      url: `https://${process.env.OBJECT_STORAGE_DOMAIN}/pages/page_b/main-banner.jpg`,
    },
    secondaryBanner: {
      index: 1,
      url: `https://${process.env.OBJECT_STORAGE_DOMAIN}/pages/page_b/secondary-banner-2.jpg`,
    },
    updatedAt: new Date(),
    createdAt: new Date(),
  },
  ...
  },
  {
    ...
    mainBanner: {
      index: 1,
      url: `https://${process.env.OBJECT_STORAGE_DOMAIN}/pages/page_d/main-banner.jpg`,
    },
    secondaryBanner: {
      index: 1,
      url: `https://${process.env.OBJECT_STORAGE_DOMAIN}/pages/page_d/secondary-banner-3.jpg`,
    },
    updatedAt: new Date(),
    createdAt: new Date(),
  },
