...
const pages: PageModel[] = [
  {
    ...
    mainBanner: `/assets/${ASSETS_DIST_PAGES}/page_a/main-banner.jpg`,
    mainBannerMobile: `/assets/${ASSETS_DIST_PAGES}/page_a/main-banner-mobile.jpg`,
    secondaryBanner: `/assets/${ASSETS_DIST_PAGES}/page_a/secondary-banner-1.jpg`,
    updatedAt: new Date(),
    createdAt: new Date(),
  },
  {
    ...
    showAsMainBanner: true,
    showAsSecondaryBanner: true,
    mainBanner: `/assets/${ASSETS_DIST_PAGES}/page_b/main-banner.jpg`,
    secondaryBanner: `/assets/${ASSETS_DIST_PAGES}/page_b/secondary-banner-2.jpg`,
    updatedAt: new Date(),
    createdAt: new Date(),
  },
  {
  ...
  },
  {
    ...
    showAsMainBanner: true,
    showAsSecondaryBanner: true,
    mainBanner: `/assets/${ASSETS_DIST_PAGES}/page_d/main-banner.jpg`,
    secondaryBanner: `/assets/${ASSETS_DIST_PAGES}/page_d/secondary-banner-3.jpg`,
    updatedAt: new Date(),
    createdAt: new Date(),
  },
  {
